...
function setDefaults(){
  $('#mod-6w-r0-yes, #mod-6w-r1-yes, #mod-6w-r2-yes, #mod-6w-r3-yes, #mod-6w-r0-no, #mod-6w-r1-no, #mod-6w-r2-no, #mod-6w-r3-no')
    .click(function(){
      if (!$("input:radio[name='mod-6w-r0']").is(":checked") || 
        !$("input:radio[name='mod-6w-r1']").is(":checked") ||
        !$("input:radio[name='mod-6w-r2']").is(":checked") ||
        !$("input:radio[name='mod-6w-r3']").is(":checked")
      ) {
        updatePolicy()
        $('#mod-6w-collapse').collapse('hide')
      } else if ($("#mod-6w-r0-yes").prop("checked") && $("#mod-6w-r1-yes").prop("checked") && $("#mod-6w-r2-yes").prop("checked") && $("#mod-6w-r3-yes").prop("checked")) {
        $('#mod-6w-ccpa-info').html('The CCPA is applicable to your app.')
        $('#mod-6w-more, #mod-6w-ccpa-info').fadeIn()
        updatePolicy()
      } else {
        $('#mod-6w-ccpa-info').fadeIn()
        $('#mod-6w-ccpa-info').html('The CCPA is not applicable to your app.')
        $('#mod-6w-more').fadeOut()
        updatePolicy()
        $('#mod-6w-collapse').collapse('hide')
      }
  })
  $('#mod-6w-more').click(function(){
    $('#mod-6w-collapse').collapse('show')
  })
  $('#mod-6w-add-source').click(function(){
    let html =`
    ...
    `
    $('#mod-6w-content-1').html(html)
    $('#mod-6w-addS').click(function(){
      if ($('#mod-6w-input-source-0').val() != "" &&
        $('#mod-6w-input-source-1').val() != "" &&
        $('#mod-6w-input-source-2').val() != "") {
          $('#mod-6w-input-source-0').attr('placeholder', 'Enter source (Ex. Quantcast)')
          $('#mod-6w-input-source-1').attr('placeholder', 'Enter category (Ex. E-mail address)')
          $('#mod-6w-input-source-2').attr('placeholder', 'Enter purpose (Ex. Marketing)')
        
        sources[count] = 
          {"SOURCE": $('#mod-6w-input-source-0').val(),
          "CATEGORY": $('#mod-6w-input-source-1').val(),
          "PURPOSE": $('#mod-6w-input-source-2').val(),
          "USED": true
          }
        count ++
        updateWizard0()
        ...
        $('#mod-6w-input-source-2').val("")
        $('#mod-6w-input-source-1').val("")
        $('#mod-6w-input-source-0').val("")
        updatePolicy()
      } else {
        $('#mod-6w-input-source-0').attr('placeholder', 'This field is required')
        $('#mod-6w-input-source-1').attr('placeholder', 'This field is required')
        $('#mod-6w-input-source-2').attr('placeholder', 'This field is required')
      }
    })
    $('#mod-6w-collapse-1').collapse('show')
  })

  $('#mod-6w-input-rights').off().on('input', function(){
    updatePolicy()
  })

  $('#mod-6w-do-not-sell').on('input', function() {
    updatePolicy()
  })
  ...
  $('#mod-6w-r4-yes').click(function(){
    $('#mod-6w-soldInfo-more').fadeIn()
    updatePolicy()
  })
  $('#mod-6w-r4-no').click(function(){
    $('#mod-6w-soldInfo-more').fadeOut()
    updatePolicy()
  })
  $('#mod-6w-r5-yes').click(function(){
    $('#mod-6w-disInfo-more').fadeIn()
    updatePolicy()
  })
  $('#mod-6w-r5-no').click(function(){
    $('#mod-6w-disInfo-more').fadeOut()
    updatePolicy()
  })
  inflateDisInfoBtns()
  $('#mod-6w-collapse-disInfo-add').click(function(){
    let html =`
    ...
    <div class="d-flex flex-row justify-content-between">
      ...
      class="btn close pl-2 ml-auto"
      data-toggle="collapse" 
      data-target="#mod-6w-collapse-disInfo"
      >
      <div class="close-char">
          <span aria-hidden="true">&times;</span>
      </div>
    ...
    <div class="d-flex flex-column mt-1">
      <div class="mt-2"><small>Category</small></div>
        <input 
          ...
          id="mod-6w-input-add-disInfo">
        <a 
          href="#" 
          class="badge badge-dark badge-pill align-self-start mt-3"
          id="mod-6w-add-disInfo">
          Add
        </a>
      </div>
    </div>    
    ...
    $('#mod-6w-collapse-disInfo').html(html)
    $('#mod-6w-add-disInfo').off()
    $('#mod-6w-add-disInfo').click(function(){
      if ($('#mod-6w-input-add-disInfo').val() != "") {
        disInfo[count] = {
          "NAME": $('#mod-6w-input-add-disInfo').val(),
          "SDKS": {},
          "DEFAULT": false
        }
        $('#mod-6w-input-add-disInfo').attr('placeholder', 'Enter category')
        count ++
        inflateDisInfoBtns()
        $('#mod-6w-input-add-disInfo').val("")
        scrollHorizontalEnd('mod-6w-disInfo')
      } else {
        $('#mod-6w-input-add-disInfo').attr('placeholder', 'This field is required')
      }
    })
    $('#mod-6w-collapse-disInfo').collapse('show')
  })

  inflateSoldInfoBtns()
  $('#mod-6w-collapse-soldInfo-add').click(function(){
    let html =`
    <div class="card card-body">
    <div class="d-flex flex-row justify-content-between">
      <div>
      ...
      class="btn close pl-2 ml-auto"
      data-toggle="collapse" 
      data-target="#mod-6w-collapse-soldInfo"
      >
      <div class="close-char">
          <span aria-hidden="true">&times;</span>
      </div>
    ...
    <div class="d-flex flex-column mt-1">
      <div class="mt-2"><small>Category</small></div>
        <input
          ...
          type="text" 
          placeholder="Enter category" 
          id="mod-6w-input-add-soldInfo">
        <a 
          href="#" 
          class="badge badge-dark badge-pill align-self-start mt-3"
          id="mod-6w-add-soldInfo">
          Add
        </a>
      </div>
    </div>    
    ...
    $('#mod-6w-collapse-soldInfo').html(html)
    $('#mod-6w-add-soldInfo').off()
    $('#mod-6w-add-soldInfo').click(function(){
      if ($('#mod-6w-input-add-soldInfo').val() != "") {
        $('#mod-6w-input-add-soldInfo').attr('placeholder', 'Enter category')
        soldInfo[count] = {
          "NAME": $('#mod-6w-input-add-soldInfo').val(),
          "SDKS": {},
          "DEFAULT": false
        }
        count ++
        inflateSoldInfoBtns()
        $('#mod-6w-input-add-soldInfo').val("")
        scrollHorizontalEnd('mod-6w-soldInfo')
      } else {
        $('#mod-6w-input-add-soldInfo').attr('placeholder', 'This field is required')
      }
    })
    $('#mod-6w-collapse-soldInfo').collapse('show')
  })
  $('#mod-6w-r6-yes').click(function(){
    $('#mod-6w-f, #mod-6w-input-financial').fadeIn()
    updatePolicy()
  })
  $('#mod-6w-r6-no').click(function(){
    $('#mod-6w-f, #mod-6w-input-financial').fadeOut()
    updatePolicy()
  })
  $('#mod-6w-input-financial').on('input', function(){
    updatePolicy()
  })
  $('#mod-6w-r7-yes').click(function(){
    $('#mod-6w-annual').fadeIn()
    updatePolicy()
  })
  $('#mod-6w-r7-no').click(function(){
    $('#mod-6w-annual').fadeOut()
    updatePolicy()
  })
  $('#mod-6w-input-annual-0').on('input', function(){
    updatePolicy()
  })
  $('#mod-6w-input-annual-1').on('input', function(){
    updatePolicy()
  })
  $('#mod-6w-input-annual-2').on('input', function(){
    updatePolicy()
  })
  $('#mod-6w-input-annual-3').on('input', function(){
    updatePolicy()
  })
  $('#mod-6w-r8-yes').click(function(){
    if (
    $('#mod-6w-r8-yes').prop('checked')
    ) {
      $('#mod-6w-process, #mod-6w-input-process').fadeIn()
    }
    updatePolicy()
  })
  $('#mod-6w-r8-no').click(function(){
    $('#mod-6w-process, #mod-6w-input-process').fadeOut()
    updatePolicy()
  })
  $('#mod-6w-input-process').on('input', function(){
    updatePolicy()
  })
}
    ...
    visibility = 'd-none'
      ...
      <div class="card card-body">
        <div class="d-flex flex-row justify-content-between">
          ...
          class="btn close pl-2 ml-auto"
          data-toggle="collapse"
          id="mod-6w-collapse-close-disInfo"
          data-target="#mod-6w-collapse-disInfo"
          >
          <div class="close-char">
              <span aria-hidden="true">&times;</span>
        ...
        <div class="d-flex flex-column mt-1">
          ...
          <div class="d-flex flex-column shadow-sm" id="mod-6w-sdks-1-info"></div>
        </div>    
      </div>
      `
      $('#mod-6w-collapse-disInfo').html(html)
      smoothScroll()
      $('#mod-6w-collapse-close-disInfo').off()
      $('#mod-6w-collapse-close-disInfo').click(function(){
        $('.disInfo').removeClass('focus')
      })
      $('#mod-6w-delete-disInfo').off()
      $('#mod-6w-delete-disInfo').click(function(){
        delete disInfo[key]
        inflateDisInfoBtns()
        $('.disInfo').removeClass('focus')
        $('#mod-6w-collapse-disInfo').collapse('hide')
        updatePolicy()
      })
      injectSDKS1(key)
}
    ...
    visibility = 'd-none'
      ...
      <div class="card card-body">
        <div class="d-flex flex-row justify-content-between">
          ...
          class="btn close pl-2 ml-auto"
          data-toggle="collapse"
          id="mod-6w-collapse-close-soldInfo"
          data-target="#mod-6w-collapse-soldInfo"
          >
          <div class="close-char">
              <span aria-hidden="true">&times;</span>
        ...
        <div class="d-flex flex-column mt-1">
          ...
          <div class="d-flex shadow-sm flex-column" id="mod-6w-sdks-0-info"></div>
        </div>    
      </div>
      `
      $('#mod-6w-collapse-soldInfo').html(html)
      smoothScroll()
      $('#mod-6w-collapse-close-soldInfo').off()
      $('#mod-6w-collapse-close-soldInfo').click(function(){
        $('.soldInfo').removeClass('focus')
      })
      $('#mod-6w-delete-soldInfo').off()
      $('#mod-6w-delete-soldInfo').click(function(){
        delete soldInfo[key]
        inflateSoldInfoBtns()
        $('.soldInfo').removeClass('focus')
        $('#mod-6w-collapse-soldInfo').collapse('hide')
        updatePolicy()
      })
      injectSDKS0(key)
}
...
function injectSDKS1(category) {
  ...
  $.each(sdks, function(key, value) {
    ...
    if (sdks[key]["USED"] && disInfo[category]['SDKS'][key]["USED"]){
      html += `
        <button
          type="button" 
          class="btn btn-sm btn-outline-tp font-weight-bold text-nowrap mod6w-1"
          id="` + key + `mod6w-1">
          <img
      ...
      <button
        type="button" 
        class="btn btn-sm btn-outline-secondary-alt text-nowrap mod6w-1"
        id="` + key + `mod6w-1">
        <img
        src="img/minus-square-outline.svg"
        height="18px"
  ...
  $('#mod-6w-sdks-1').html(html + "&nbsp;&nbsp;")
  $('#mod-6w-smooth').click(function(){
    document.getElementById('section-2').scrollIntoView({behavior: 'smooth'})
  })
  $('.mod6w-1').off()
  $('.mod6w-1').each(function(){
    $(this).click(function(){
      $('.mod6w-1').removeClass('focus')
      $(this).addClass('focus')
      ...
      $('#mod-6w-usage-1').click(function(){
        ...
        $('#'+key+ "mod6w-1").addClass('focus')
        updatePolicy()
      })
      $('#mod-6w-input-purpose-1').off()
      $('#mod-6w-input-purpose-1').on('input', function(){
...
function injectSDKS0(category) {
  ...
  $.each(sdks, function(key, value) {
    ...
    if (sdks[key]["USED"] && soldInfo[category]['SDKS'][key]["USED"]){
      html += `
        <button
          type="button" 
          class="btn btn-sm btn-outline-tp text-nowrap mod6w font-weight-bold"
          id="` + key + `mod6w">
          <img
          src="img/checkmark-square-2-alt.svg"
          height="18px"
      ...
      <button
        type="button" 
        class="btn btn-sm btn-outline-secondary-alt text-nowrap mod6w"
        id="` + key + `mod6w">
        <img
        src="img/minus-square-outline.svg"
        height="18px"
  ...
  $('#mod-6w-sdks-0').html(html + "&nbsp;&nbsp;")
  $('#mod-6w-smooth-1').click(function(){
    document.getElementById('section-2').scrollIntoView({behavior: 'smooth'})
  })
  $('.mod6w').off()
  $('.mod6w').each(function(){
    $(this).click(function(){
      $('.mod6w').removeClass('focus')
      $(this).addClass('focus')
      let name = $(this).text().trim()
      ...
      <div class="card card-body mt-2">
        ...
        <input 
          type="text" 
          id="mod-6w-input-purpose-0"
          value="`+soldInfo[category]['SDKS'][key]["PURPOSE"]+`"
          placeholder="This personal information is used to...">
      </div>
      `
      $('#mod-6w-sdks-0-info').html(html)
      $('#mod-6w-usage-0').off()
      $('#mod-6w-usage-0').click(function(){
        if (soldInfo[category]['SDKS'][key]["USED"]) {
          $(this).text("Add")
        } else {
          $(this).text("Remove")
        ...
        $('#'+key+ "mod6w").addClass('focus')
        updatePolicy()
      })
      $('#mod-6w-input-purpose-0').off()
      $('#mod-6w-input-purpose-0').on('input', function(){
...
function updateWizard0(){
  ...
  $.each(sources, function(key, value) {
    if (sources[key]["USED"]) {
      ...
      <button
        type="button" 
        class="btn btn-sm btn-outline-info-alt text-nowrap 6w-s font-weight-bold"
        id="` + key + `s-btn">
        <img
        class="mr-2"
        src="img/checkmark-square-2.svg"
  ...
  $('.6w-s').each(function(){
    ...
    $(this).click(function(){
      ...
      `
      $('#mod-6w-content-1').html(html)
      $('#mod-6w-input-source-1').off()
      $('#mod-6w-input-source-1').on('input', function(){
        sources[key]["CATEGORY"] = $(this).val()
        updatePolicy()
      })
      $('#mod-6w-input-source-2').off()
      $('#mod-6w-input-source-2').on('input', function(){
        sources[key]["PURPOSE"] = $(this).val()
        updatePolicy()
      })
      $('#mod-6w-deleteS').off()
      $('#mod-6w-deleteS').click(function(){
        delete sources[key]
        $('#mod-6w-collapse-1').collapse('hide')
        updateWizard0()
        updatePolicy()
      })
      $('#mod-6w-collapse-close').off()
      $('#mod-6w-collapse-close').click(function(){
        $('.6w-s').removeClass('focus')
      })
      $('#mod-6w-collapse-1').collapse('show')
    })
...
function updatePolicy(){
  if (!$("input:radio[name='mod-6w-r0']").is(":checked") || 
    ...
    let html2 = $('#mod-6w-input-rights').attr('placeholder')
    if ($('#mod-6w-input-rights').val() != "") {
      html2 = $('#mod-6w-input-rights').val()
    }
    ...
    if (html3 != "" && $('#mod-6w-r4-yes').prop('checked')){
      let _html3 = ""
      if ($('#mod-6w-do-not-sell').val() != "") {
        _html3 = "our <a href='"+$('#mod-6w-do-not-sell').val() +"' target='_blank'>web form</a> or"
      }
      html3 = `
    ...
    if (html4 != "" && $('#mod-6w-r5-yes').prop('checked')){
      html3 += `
      <p>
    ...
    if($('#mod-6w-r6-yes').prop('checked')) {
      let tempHtml = ""
      if ($('#mod-6w-input-financial').val() == "") {
        tempHtml = '<span style="opacity: .25;">&lt;description of financial incentive&gt;</span>'
      } else {
        tempHtml = $('#mod-6w-input-financial').val()
      }
      html5 = `
    ...
    if ($('#mod-6w-r7-yes').prop('checked')) {
      ...
      `+$('#mod-6w-input-annual-3').val()+`
      </p>
      `
    }

    let html7 ="<div id='california_review_changes'></div>"
    if ($('#mod-6w-r8-yes').prop('checked')
    ) {
      let tempHtml = ""
      if ($('#mod-6w-input-process').val() == "") {
        tempHtml = '<span style="opacity: .25;">&lt;description of process&gt;</span>'
      } else {
        tempHtml = $('#mod-6w-input-process').val()
      }
      html7 = `
...
export function syncMod6( login ){
